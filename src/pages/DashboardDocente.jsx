...
export const DashboardDocente = () => {
  const [resumen, setResumen] = useState({ estudiantes: 0, alertas: 0 });
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        setGruposEstudiante(Object.values(mapa).sort((a, b) => b.total - a.total));
      } catch (error) {
    ...
    <main className="flex-1 space-y-4">
      ...
      <div className="grid grid-cols-12 gap-4">
        <div className="col-span-12 md:col-span-8 space-y-2">
          <h3 className="font-semibold text-lg">Mis estudiantes con alertas</h3>
